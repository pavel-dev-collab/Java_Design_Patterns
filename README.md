...
| Pattern | Description |
| :--- | :--- |
| **Adapter** | Converts an incompatible interface into an expected one |
...
| Pattern | Description |
| :--- | :--- |
| **Observer** | Defines a provider-subscriber relationship to notify state changes |
...
| **Iterator** | Accesses elements of a collection sequentially without exposing its underlying form |
